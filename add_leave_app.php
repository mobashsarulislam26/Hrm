...
<section class="content">
  <div class="container-fluid">
   ...
   <h3>Leave Application Form List</h3>
   <table class="table table-bordered">
    ...
    <?php
    $add=$conn->query("SELECT leave_application.applicationID,employee.name,leave_type.title,start_date,end_date,comment FROM `leave_application` JOIN employee ON employee.empID=leave_application.empID JOIN leave_type ON leave_type.typeID=leave_application.typeID");
    ...
    while($i=$add->fetch_assoc()){?>
      <tr>
        ...
        <td>
          <a href="update_leave_app.php?id=<?php echo $i['applicationID'] ?>" class="btn btn-xs btn-primary">Edit</a>
          <a href="delete_leave_app.php?id=<?php echo $i['applicationID'] ?>" class="btn btn-xs btn-danger">Delete</a>
        </td>
      </tr>
      <?php  
    }
