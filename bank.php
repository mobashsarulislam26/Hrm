        ...
        <div class="card">
          ...
          <div class="card-body">
           <form action="" method="post">
            ...
            <br>
            <td colspan="6">
               <input type="Submit" value="Submit"class="btn btn-outline-success btn btn-block">
            </td>
      ...
      <tbody>
        ...
        while($ban_data = $bank_data->fetch_assoc()){ ?>
          <tr>
            ...
            <td scope="row">
             <a href="./bank_edit.php?ram=<?php echo $ban_data['bankID']; ?>" class="btn btn-sm btn-success">Edit</a> ||
             <a href="./bank_delete.php?ram=<?php echo $ban_data['bankID']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('are you sure?')">Delete</a>
           </td>                        
         </tr>
