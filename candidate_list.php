                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if ($c['shortlisted'] == "no") { ?>
                                                <a href="candidate_list.php?srtId=<?php echo $c['id'] ?>&type=no" class="btn btn-sm btn-info" title="Add to shortlist"><i class="fas fa-user-check"></i></a>
                                            <?php
                                            } else { ?>
                                                <a href="candidate_list.php?srtId=<?php echo $c['id'] ?>&type=yes" class="btn btn-sm btn-danger" title="Add to shortlist"><i class="fas fa-user-times"></i></a>
                                            <?php
                                            }
                                            ?>
