                ...
                <tr>
                  ...
                  <td class="text-bold pt-4">
                    ...
                    if ($_SESSION['name'] == "admin") {
                      ...
                      if ($value[7] == "rejected") { ?>
                        <button type="button" class="btn btn-xs btn-success mt-2 " onclick="approve_<?php echo $value[0]; ?>()" title="Approve">
                  ...
                  <td class="align-middle">
                    ...
                    if ($_SESSION['name'] !== "admin") { ?>
                      ...
                      <a href="leaveApplicationEdit.php?eid=<?php echo $value[0]; ?>" title="Edit Leave" class=" btn btn-xs mt-2 btn-success"> <i class="fas fa-edit"> </i></a>
