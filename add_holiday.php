...
if(isset($_POST['title'])){
  ...
  $end=$_POST['end_date'];
 $conn->query("INSERT INTO `holiday` (`holidayID`, `title`, `start_date`, `end_date`) VALUES (NULL, '$name', '$start', '$end');");
          ...
          <div class="col-md-12">
            <div class="card">
              ...
              <!-- /.card-header -->
                    ...
                    <!-- <br>
                    <a href="dashboard.php" class="button-button-success">back</a> -->
                  </div>
               ...
               <form action="" method="post">
                <table class="table table-bordered"style="hover:background-color:red;">
                  <tr>
                    <th>ID</th>
                    <td>
                      <input type="text" name="holidayID" class="from-control"> 
