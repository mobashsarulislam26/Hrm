          ...
          <div class="card-body">
            ...
            <form action="" method="post">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-4 text-right">
                  <input type="submit" value="Check In" class="btn btn-success w-md m-b-5">
                </div>
              </div>
            </form>
            <hr>
            ...
            <div class="panel-body">
              <div class="table-responsive">
                <table width="100%" class="table table-success table-striped table-bordered table-hover text-center ">
                  <tbody>
                    <tr>
                    ...
                    foreach ($fetch as $key => $value) { ?>
                      <tr>
                        ...
                        <td>
                          <a class=" btn btn-sm  btn-success " href="atten_edit.php?eid=<?php echo $value[3]; ?>"><i class="fas fa-edit"></i></a> |
