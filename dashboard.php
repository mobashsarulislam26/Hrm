      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header">
            <h2 class="card-title text-center">Income & Expense</h2>
          </div>
          <!-- /.card-header -->
          <div class="card-body">
            ...
            <script>
              am4core.ready(function() {
                ...
                chart.data = [
                  ...
                  ?> {
                    "country": "Income",
                    "litres": <?php echo $in_total['in_total'] ?>,
                    "subData": [
                      <?php
                  ...
                  ?> {
                    "country": "Expense",
                    "litres": <?php echo $exp_total['exp_total'] ?>,
                    "subData": [
                      <?php
            ...
            ?>
            <h2 class="text-center  my-5">Notice List</h2>
            <table class="table table-bordered">
              ...
              <tr>
                <?php
                $db=$conn->query("SELECT * FROM `notice` WHERE date BETWEEN '".$efd."' AND '".$eld."' ORDER BY date DESC LIMIT 4");
