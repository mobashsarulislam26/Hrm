							...
							<table class="table table-striped table-hover">
								...
								<tbody>
									...
									<tr>
										...
										<td>
											<a href="./admin_edit.php?ram=<?php echo $one['adminID']; ?>" class="btn btn-sm btn-success">Edit</a> || 
											<a href="./admin_delete.php?ram=<?php echo $one['adminID']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('are you sure?')">Delete</a>
										</td>
									</tr>
									<?php   } ?>
