...
$expense_data=$conn->query("SELECT `exoenseID`,expense_category.id,`date`,`amount`,`method`,`bankID` FROM `expense` JOIN expense_category ON expense_category.id=expense.categoryID");
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="card">
          ...
          <div class="container">
          <div class="card-body">
            <h1 style="text-align: center; color: green"> Add an Expense</h1>
              ...
              <table class="table table-striped table-hover">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><?php echo $expense['bankID']?></td>
                    <td>
                      <a href="./expense_edit.php?ram=<?php echo $expense['exoenseID']; ?>" class="btn btn-sm btn-success">Edit</a> || 

                      <a href="./expense_delete.php?ram=<?php echo $expense['exoenseID']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('are you sure?')">Delete</a>
                    </td>
                  </tr>
                  <?php   } ?>
