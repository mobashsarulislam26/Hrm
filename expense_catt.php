...
<section class="content">
      <div class="container-fluid">
        ...
        <!-- <a href="expense_catt.php" class="btn btn-sm btn-success  float-right">Add New</a> -->
    ...
    <h2 class="mt-5">Expense categories</h2>
    ...
    <table class="table table-striped table-hover">
      ...
      <tr>
        ...
        <td>
          <a href="expense_catt_up.php?id=<?php echo  $data['id']; ?>" class="btn btn-sm btn-success fas fa-edit"></a>
