      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header">
            ...
            <button class="btn btn-xs btn-success float-right" onclick="add_new()">Add Education</button>
          </div>
          <!-- /.card-header -->
          <div class="card-body">
            <form action="" method="POST">
              ...
              <button type="submit" name="submit" class="btn btn-success btn-block">Next</button>
              ...
              <tbody>
                <?php while ($e = $edu->fetch_assoc()) { ?>
                  <tr>
                    ...
                    <td><a href="edit_cnd_edu.php?id=<?php echo $e['eduID'] ?>" class="btn btn-success btn-sm">Edit</a> | <a href="candidate_education.php?delId=<?php echo $e['eduID'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure?')">Delete</a></td>
                  </tr>
                <?php } ?>
