                                 ...
                                 while ($value=$att_data->fetch_assoc()) { ?>
                                    ...
                                    <tr>
                                      ...
                                      <td>
                                        ...
                                        <a title="See Details"  class=" btn btn-sm  btn-success " href="attendance_log.php?empid=<?php if( isset($value['empID'])) {echo $value['empID'];} ?>"><i class="fas fa-info-circle"></i></a>
