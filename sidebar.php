    ...
    <div class="sidebar">
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          ...
          <a href="admin.php" class="d-block text-warning">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="holiday.php" class="nav-link text-warning">
          ...
          <li class="nav-item">
            <a href="bank.php" class="nav-link text-warning">
          ...
          <li class="nav-item">
            <a href="profit_loss.php" class="nav-link text-warning">
          ...
          <li class="nav-item">
            <a href="add_notice.php" class="nav-link text-warning">
