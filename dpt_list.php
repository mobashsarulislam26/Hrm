                   ...
                   $dpt_data = $conn->query("SELECT * FROM `department`");
                        ...
                        while($dp_data = $dpt_data->fetch_assoc()){ ?>
                            <tr>
                              ...
                              <td scope="row">
                                 <a href="./dpt_edit.php?id=<?php echo $dp_data['dptID']; ?>" class="btn btn-sm btn-success">Edit</a>
                                 <a href="./dpt_delete.php?id=<?php echo $dp_data['dptID']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('are you sure?')">Delete</a>
                              </td>                        
                            </tr>
