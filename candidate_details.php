        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a class="btn btn-success" href="candidate_list.php">Candidate list</a></li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
                                        ...
                                        <tbody>
                                            <?php while ($e = $edu->fetch_assoc()) { ?>
                                                <tr>
                                                    ...
                                                    <td><a href="edit_cnd_edu.php?id=<?php echo $e['eduID'] ?>" class="btn btn-success btn-sm"><i class="fas fa-edit"></i></a> | <a href="candidate_education.php?delId=<?php echo $e['eduID'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure?')"><i class="fas fa-trash"></i></a></td>
                                                </tr>
                                            <?php } ?>
                                        ...
                                        <tbody>
                                            <?php while ($j=$job->fetch_assoc()) { ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="jobExEdit.php?id=<?php echo $j['candidateID']; ?>" class="btn btn-sm btn-success"><i class="fas fa-edit"></i></a>
