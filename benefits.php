...
<section class="content">
      ...
      <td>
        <a href="benefits_update.php?id=<?php echo $cc['id'] ?>"class="btn btn-success">Edit</a>
        <a href="benefits_delete.php?id=<?php echo $cc['id'] ?>" class="btn btn-danger">Delete</a>
      </td>
      </tr>
