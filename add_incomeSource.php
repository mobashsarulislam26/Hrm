      ...
      <table class="table table-bordered">
        ...
        <tr>
          ...
          while($i=$db->fetch_assoc()){?>
            ...
            <td>
              <a href="update_incomeSource.php?id=<?php echo $i['id'] ?>" class="btn btn-xs btn-primary">Edit</a>
              <a href="delete_incomeSource.php?id=<?php echo $i['id'] ?>" class="btn btn-xs btn-danger">Delete</a>
            </td>
          </tr>
        <?php } ?>
      </table>
