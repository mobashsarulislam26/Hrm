            ...
            <table class="table table-bordered">
              ...
              ?>
                ...
                <tr>
                  ...
                  <td>
                    <a href="update_income.php?id=<?php echo $i['incomeID'] ?>" class="btn btn-xs btn-primary">Edit</a>
                    <a href="delete_income.php?id=<?php echo $i['incomeID'] ?>" class="btn btn-xs btn-danger">Delete</a>
                  </td>
                </tr>
              <?php  } ?>
