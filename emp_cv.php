...
<body>
    ...
    <td rowspan="10"></td>
		...
		<table class="table table-hover">
			...
			<th colspan="4"> <h2 style="text-align: center; color: green">Details of <?php echo $result['name']; ?> </h2> </th>
			<a href="view_emp.php" class="float-left btn btn-sm btn-success"><-Back</a>
			</tr>
