                         ...
                         ?>
                           <tr>
                              ...
                              <td class="align-middle">
                               ...
                               <!--  <a href="attendance_log_edit.php?editId=<?php if(isset($att2['attID'])) {echo $att2['attID'];} ?>&emp_id=<?php echo $att2['empID']; ?>" class="btn btn-sm btn-success"><i class="fas fa-edit"></i></a>  -->                           
