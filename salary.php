                    ...
                    <div class="card-header">
                        <div class="col-md-4">
                            <form action="" method="post">
                                ...
                                <input type="submit" class="btn btn-block btn-success mt-1" value="Select">
                            </form>
                        </div>
                    </div>
                    <!-- /.card-header -->
                                ...
                                while ($e = $employee->fetch_assoc()) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            $mID=$mon["id"];
                                            ?>
                                            <a href="salaryPayMethod.php?empID=<?php echo $empID ?>&payDate=<?php echo date("Y-m-d") ?>&amount=<?php echo $net_salary ?>&month=<?php echo $mID ?>" class="btn btn-success"> Pay </a>
                                        </td>
                                    </tr>
                                <?php
                                }
